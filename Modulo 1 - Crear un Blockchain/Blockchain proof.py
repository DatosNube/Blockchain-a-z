# -*- coding: utf-8 -*-
"""
Created on Tue Nov 23 22:41:11 2021
...
class Blockchain:
    ...
    def is_chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            if block['preicous_hash'] != self.hash(previous_block):
                return False
...
app = Flask(__name__)
#Se se obtiene un error 500, actualizar flask, reiniciar spyder y ejecutar la siguiente linea
...
def mine_block():
    ...
    response = {'message' : '¡Enhorabuena, has minado un nuevo bloque!', 
                ...
                'proof' : block['proof'],
                'previou_hash' : block['previous_hash']}
